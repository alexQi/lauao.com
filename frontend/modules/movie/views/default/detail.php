            ...
            <div class="filmplay">
                <div class="film-main banner-wrap">
                    <div class="video-js-box vim-css" id="mod_player">
                        <!--
                        <video id="xpc_video" class="video-js" width="960" height="540" preload="auto"
                               controls="controls" pw="960" poster="<?php echo $videoDetail['poster']; ?>"
                               webkit-playsinline src="<?php echo $videoDetail['video_url']; ?>"
                               alt="<?php echo $videoDetail['video_name'] . '--' . $videoDetail['uploader']; ?>">
                            <source src="<?php echo $videoDetail['video_url']; ?>" type="video/mp4"/>
                            <object id="flash_fallback_1" class="vjs-flash-fallback" width="960" height="540"
                                    type="application/x-shockwave-flash"
                                    data="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf">
                                <param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf"/>
                                <param name="allowfullscreen" value="true"/>
                                <param name="flashvars"
                                       value='config={"playlist":["<?php echo $videoDetail['video_url']; ?>","autoPlay":false,"autoBuffering":true}]}'/>
